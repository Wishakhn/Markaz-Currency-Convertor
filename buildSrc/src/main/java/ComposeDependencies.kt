...
object ComposeDependencies {
    ...
    const val COMPOSE_WINDOW_SIZE = "androidx.compose.material3:material3-window-size-class:${ComposeVersion.MATERIAL_3}"
    // Integration with observablesComposeDependenciesVersions
    const val COMPOSE_CONSTRAINT_LAYOUT = "androidx.constraintlayout:constraintlayout-compose:${ComposeVersion.COMPOSE_CONSTRAINT}"
    const val COMPOSE_NAVIGATION = "androidx.navigation:navigation-compose"
    const val COMPOSE_VIEW_MODEL = "androidx.lifecycle:lifecycle-viewmodel-compose:${ComposeVersion.COMPOSE_VM}"
